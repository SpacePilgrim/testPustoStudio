...
# В случае использования иной БД или при необходимости получения универсального решения я бы использовал еще одну модель, например, PlayerBoosts, в которой хранил бы идентификатор игрока, идентификатор буста и количество выданных игроку бустов.
